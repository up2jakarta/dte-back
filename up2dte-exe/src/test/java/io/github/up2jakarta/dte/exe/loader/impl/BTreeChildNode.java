...
public abstract class BTreeChildNode extends BTreeNode implements ChildNode, Comparable<ChildNode> {

    private final int order;
    private final ParentNode parent;
    private final boolean negated;

    BTreeChildNode(final long id, final ParentNode parent, final int order, final boolean negated) {
        super(id);
        this.parent = parent;
